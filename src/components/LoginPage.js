    ...
    return (
        <div style={{display: "flex", alignItems: "center", height: "100vh"}}>
            <div style={{margin: "auto"}}>
                ...
                {Date.now() > new Date(2021, 10, 29) ? <EndPage/>
                    :
                        ...
                        <div className="content">
                            <div className={"notification is-light is-info"}>
                                ...
                                <p>
                                    ...
                                    um die Studie fortzusetzen. Eine erneute Anmeldung ist auch nach dem 07.11.21 möglich.
                                </p>
                                    ...
                                    <div className="field">
                                        <div className="control">
                                            <p className={"help is-danger"} style={{visibility: props.badLogin ? "visible" : "hidden"}}>
                                                ...
                                                verbunden sind. Beachten Sie, dass Ihre Zugangsdaten zum 08.11.21 ablaufen, falls
